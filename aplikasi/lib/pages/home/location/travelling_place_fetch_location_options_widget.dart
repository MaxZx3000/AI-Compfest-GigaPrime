...
class _TravellingPlaceFetchLocationOptionsWidgetState extends State<TravellingPlaceFetchLocationOptionsWidget>{
  ...
  List<CheckboxListTile> _getAllCitiesCheckboxes(){
    ...
    List<CheckboxListTile> checkboxElements = List.generate(checkboxValues.length, (index) {
      return CheckboxListTile(
        title: Text(checkboxKeys[index]),
        value: widget.checkboxesCitiesValue[checkboxKeys[index]],
        onChanged: (bool? checked){
          setState(() {
            widget.checkboxesCitiesValue[checkboxKeys[index]] = checked! ? true : false;
          });
        },
      );
    }
  ...
  List <CheckboxListTile> _getAllCategoriesCheckboxes(){
    ...
    List<CheckboxListTile> checkboxElements = List.generate(checkboxValues.length, (index) {
      return CheckboxListTile(
        title: Text(checkboxKeys[index]),
        value: widget.checkboxesCategoriesValue[checkboxKeys[index]],
        onChanged: (bool? checked){
          setState(() {
            widget.checkboxesCategoriesValue[checkboxKeys[index]] = checked! ? true : false;
          });
        },
      );
    }
          ...
          ElevatedButton(
              onPressed: (){
                widget.onSearchClick(
                  widget.checkboxesCitiesValue,
                  widget.checkboxesCategoriesValue,
                  widget.longitude,
                  widget.latitude,
                );
              },
